...
$(document).ready(function() {
  ...
  $(".btn-danger-simon").css("height", $(".btn-danger-simon").outerWidth() + "px");
  $(".btn-warning-simon").css("height", $(".btn-warning-simon").outerWidth() + "px");
  ...
  $("#strict").on("click", function(){ 
    isStrict = !isStrict;
    if (isStrict) {
      $("#strict").addClass("btn-danger btn-danger-simon");
      $("#strict").removeClass("btn-warning btn-warning-simon");
    } else {
      $("#strict").addClass("btn-warning btn-warning-simon");
      $("#strict").removeClass("btn-danger btn-danger-simon");
    }
  });
...
function gameReset() {
  ...
  cnt = 0;
  $("#brand").text("Simon");
  $("#result-simon").html('<i class="fa fa-gamepad fa-3x" aria-hidden="true"></i>');
  hintBlink("--");
  gamestart();
}
...
function winTheGame() {
  ...
  $("#count").text(cnt);
  $("#brand").text("WIN!");
  $("#result-simon").html('<i class="fa fa-trophy fa-4x" aria-hidden="true" style="color: #ffc107"></i>');
}
